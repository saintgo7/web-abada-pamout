...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  secondary:
    'bg-slate-600 hover:bg-slate-700 text-white border-transparent shadow-sm',
  outline:
    'bg-transparent hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 border-slate-300 dark:border-slate-700',
